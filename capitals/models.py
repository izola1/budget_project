...
class Capital(models.Model):
    ...
    func_code = models.ForeignKey(Function, on_delete=models.CASCADE)
    fund_code = models.ForeignKey(Fund, on_delete=models.CASCADE)
    loc_code = models.ForeignKey(Location, on_delete=models.CASCADE)
    # item_code = models.CharField(max_length=8)
    proj_Descripton = models.CharField(max_length=300)
    programmeCode = models.CharField(max_length=300)
    ...
    def __str__(self):
        # self.eco_code, self.ipsas_code, self.appr_prev, self.actual_prev, self.proposed_curr, self.proposed_next
        return f'{self.admin_code} {self.ipsas_code} {self.appr_prev}'


class Capitaldata(models.Model):
    ...
    projDescription = models.CharField(max_length=1000)
    ecoCode = models.CharField(max_length=8)
